<template>
  <div id="rep-app-store-module-files-test-container">
    <h3>Store Module Files Test App</h3>
...
<script>
  ...
  const RepAppStoreModuleFilesTest = {
    name: 'rep-app-store-module-files-test',
  ...
  export default RepAppStoreModuleFilesTest
