<template>
  <div id="rep-app-store-module-test-container">
    <h3>Store Module Test App</h3>
...
<script>
  ...
  const RepAppStoreModuleTest = {
    name: 'rep-app-store-module-test',
  ...
  export default RepAppStoreModuleTest
